...
import { createTextTexture, drawText, watchFonts } from './textLayer.ts';
...
export function createFluidMode(ctx: AppContext): Mode {
  ...
  return {
    ...
    resize() {
      ...
      destroyBuffers(state); Object.assign(state, createBuffers(gl, formats)); drawText(state);
    },
