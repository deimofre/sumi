...
//   node tools/regress/stroke.mjs [--out DIR] [--pressure 0.9] [--set key=value ...]
...
let ok = false;
try {
  const res = capture(head.url + `tools/regress/harness-stroke.html?pressure=${pressure}&set=` + encodeURIComponent(sets.join(',')));
